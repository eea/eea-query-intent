...
# ------------------------------------------------------------ calibration pool
CALIB_R = [
    "co2 emissions europe 2024", "air quality index 2025",
    "wfd river basin maps", "ets price history", "natura 2000 site list",
    "pfas limits table", "lulucf report 2023", "green deal documents",
    "emissions by sector", "wildfire damage photos", "ozone hole size",
    "pm2.5 annual averages", "biodiversity strategy pdf", "climate law summary",
    "emissions trading rules", "water framework directive text",
    "natura 2000 map", "co2 map europe", "air pollution deaths",
    "plastic ban timeline", "flood risk zones", "land use map",
    "greenhouse gas inventory", "eea statistics 2024", "river discharge data",
    "soil contamination sites", "noise maps europe", "invasive species list",
    "protected areas list", "emissions reduction targets", "carbon budget calculator",
    "waste statistics europe", "water scarcity index", "heat wave alerts",
    "glacier retreat photos", "dune protection rules", "pesticide residues data",
    "marine litter survey", "urban sprawl maps", "renewable energy share",
    "transport emissions split", "building emissions share",
    "agriculture emissions share", "landfill gas statistics",
    "drinking water quality", "bathing water results", "ground water levels",
    "air quality alerts", "smog episodes 2024", "carbon price forecast",
    "ets cap levels", "emissions certificates price", "co2 border tax",
    "reforestation budget 2024", "nature restoration law", "peatland map europe",
    "wildlife corridor projects", "flood protection costs", "drought index europe",
    "air pollution map", "water usage statistics", "energy consumption trends",
    "co2 per capita", "methane emissions agriculture", "nitrate levels map",
    "phosphorus runoff data", "algal bloom alerts", "dead zones map",
    "ocean temperature records", "sea level rise",
]
CALIB_U = [
    "football transfer news", "carbonara recipe pasta", "chess opening book",
    "stock market crash 2008", "learn spanish fast", "dog training tricks",
    "iphone repair guide", "movie streaming service", "crypto coin prices",
    "yoga poses list", "wedding dress ideas", "car tire pressure",
    "basketball finals scores", "dream about flying", "guitar chord charts",
]
CALIB_Q = [
